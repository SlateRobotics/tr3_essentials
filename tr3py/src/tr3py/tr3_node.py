...
class TR3_Node:
    ...
    def __init__(self, tr3 = None, init_node = True):
        ...
        rospy.Subscriber("/tr3/joints/a0/pid/set", Float32MultiArray, self.pid_a0)
        rospy.Subscriber("/tr3/joints/a1/pid/set", Float32MultiArray, self.pid_a1)  
        rospy.Subscriber("/tr3/joints/a2/pid/set", Float32MultiArray, self.pid_a2)
        rospy.Subscriber("/tr3/joints/a3/pid/set", Float32MultiArray, self.pid_a3)
        rospy.Subscriber("/tr3/joints/a4/pid/set", Float32MultiArray, self.pid_a4)
        rospy.Subscriber("/tr3/joints/h0/pid/set", Float32MultiArray, self.pid_h0)
        rospy.Subscriber("/tr3/joints/h1/pid/set", Float32MultiArray, self.pid_h1)
        rospy.Subscriber("/tr3/joints/b0/pid/set", Float32MultiArray, self.pid_b0)
        rospy.Subscriber("/tr3/joints/b1/pid/set", Float32MultiArray, self.pid_b1)

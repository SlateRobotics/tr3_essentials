...
echo "export ROS_MASTER_URI=http://192.168.8.100:11311/" >> ~/.bashrc
echo "export ROS_IP=192.168.8.100" >> ~/.bashrc
...
echo "Install complete. Once router is connected, edit the Wired Connection IP address to 192.168.8.100, Netmask to 24, and DNS to 192.168.8.1."
